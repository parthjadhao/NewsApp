...
export class News extends Component {
  ...
  fetchMoreData = async () => {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=dcfd93b5e575418a906ed05bdffd2177&page=${this.state.page}&pageSize=${this.props.pageSize}`;
